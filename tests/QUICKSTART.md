...
```yaml
# /etc/hetzner/failover-config.yaml
...
- Check file path: `/etc/hetzner/failover-config.yaml`
...
sudo chown root:root /etc/hetzner/failover-config.yaml
```

## File Locations

- Config: `/etc/hetzner/failover-config.yaml`
